...
namespace DunGen.Editor
{
	...
	public class DoorwayInspector : UnityEditor.Editor
	{
		public override void OnInspectorGUI()
		{
			...
			door.AvoidRotatingBlockerPrefab = EditorGUILayout.Toggle(new GUIContent("Avoid Door Prefab Rotation?", "If true, the chosen Door prefab will not be oriented to match the rotation of the doorway"), door.AvoidRotatingDoorPrefab);
